                ...
                <div className="flex flex-row flex-wrap w-fit gap-10 items-end md:justify-between md:w-full">
                    <div className="flex flex-col gap-8">
                        <div className="flex items-start gap-2">
                            <h2 className="font-medium text-[28px]">Контакти</h2>
                            <LuArrowUpRight size={12} />
                        </div>
                        <div className="flex flex-col gap-2">
                            <span className="block font-medium text-[14px]">EMAIL</span>
                            <span className="block">denislarin2017@gmail.com</span>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        <span className="block font-medium text-[14px]">АДРЕСА</span>
                        <span className="block">Харків, Україна</span>
                    </div>
                    <div className="flex flex-col gap-2">
